...
function th_shop_mania_import_files(){
  ...
  return apply_filters(
    ...
    array(
        'import_file_name' => esc_html__('Fashion Store','mania-companion'),
        ...
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'mania-companion' ),
       ),
    array(
        'import_file_name' => esc_html__('Fashion Shop','mania-companion'),
    ...
    array(
        'import_file_name' => esc_html__('Electro','mania-companion'),
    ...
    array(
        'import_file_name' => esc_html__('Grocery','mania-companion'),
