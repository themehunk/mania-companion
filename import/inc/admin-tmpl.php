...
<div class="wrap" id="themehunk-site-library-admin">
		...
		<div class="section-right">
			<div class="filters-wrap">
				<div id="themehunk-site-library-category"></div>
					<a href='#'   class="themehunk-site-key-link activated"><?php ucfirst($TextDomain); ?></a>
			</div>
			<div class="search-form" style="display:none;">
				<label class="screen-reader-text" for="wp-filter-search-input"><?php _e( 'Search Sites', 'mania-companion' ); ?> </label>
				<input placeholder="<?php _e( 'Search Sites...', 'mania-companion' ); ?>" type="search" aria-describedby="live-search-desc" id="wp-filter-search-input" class="wp-filter-search">
			</div>
	...
	<div class="select-page-builder">
		...
		<!-- 	<h3>
				...
				<div class="note">'Select Your themehunk Demo', 'mania-companion' ); ?></div>
			</h3>
 -->		</div>
		<!--img-->
	</div>
  ...
  <div class="themehunk-sites-preview theme-install-overlay wp-full-overlay expanded" style="display: block;">
  		<div class="wp-full-overlay-sidebar">
  			<div class="wp-full-overlay-header" data-required-plugins="{{data.required_plugins}}" data-demo-api="{{{data.demo_api}}}" data-demo-slug="{{{data.slug}}}">
  				<button class="close-full-overlay"><span class="screen-reader-text"><?php esc_html_e( 'Close', 'mania-companion' ); ?></span></button>

				<button class="previous-theme"><span class="screen-reader-text"><?php esc_html_e( 'Previous', 'mania-companion' ); ?></span></button>

				<button class="next-theme"><span class="screen-reader-text"><?php esc_html_e( 'Next', 'mania-companion' ); ?></span></button>

				<a class="button hide-if-no-customize themehunk-demo-import" href="#" data-import="disabled"><?php esc_html_e( 'Install Plugins', 'mania-companion' ); ?></a>
			</div>
			...
			<div class="wp-full-overlay-sidebar-content">
				<div class="install-theme-info">
					...
					<a href="#" class="theme-details-read-more"></a>

					<div class="required-plugins-wrap">
						<h4><?php _e( 'Required Plugins', 'mania-companion' ); ?> </h4>
				...
				<div class="footer-import-button-wrap">
					<a class="button button-hero hide-if-no-customize themehunk-demo-import" href="#" data-import="disabled">
						<?php esc_html_e( 'Install Plugins', 'mania-companion' ); ?>
					</a>
				</div>
				...
				<button type="button" class="collapse-sidebar button" aria-expanded="true"
					...
					<span class="collapse-sidebar-label"><?php esc_html_e( 'Collapse', 'mania-companion' ); ?></span>
				</button>

				<div class="devices-wrapper">
					<div class="devices">
						<button type="button" class="preview-desktop active" aria-pressed="true" data-device="desktop">
							<span class="screen-reader-text"><?php _e( 'Enter desktop preview mode', 'mania-companion' ); ?></span>
						</button>
						<button type="button" class="preview-tablet" aria-pressed="false" data-device="tablet">
							<span class="screen-reader-text"><?php _e( 'Enter tablet preview mode', 'mania-companion' ); ?></span>
						</button>
						<button type="button" class="preview-mobile" aria-pressed="false" data-device="mobile">
							<span class="screen-reader-text"><?php _e( 'Enter mobile preview mode', 'mania-companion' ); ?></span>
						</button>
					</div>
				</div>
			</div>
		...
		<div class="wp-full-overlay-main">
			<iframe src="{{{data.demo_url}}}" title="<?php esc_attr_e( 'Preview', 'mania-companion' ); ?>"></iframe>
		</div>
  </div>
</script>
<?php
